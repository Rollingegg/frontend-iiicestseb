    ...
    <div>
        ...
        <el-table :data="tableData" stripe style="width: 100%" size="small" @row-click="jump2file">
            ...
            <el-table-column prop="authors" label="作者" width align="center" :show-overflow-tooltip="true"
                             :formatter="setAuthor"></el-table-column>
            <el-table-column prop="affiliations" label="来源" width align="center" :show-overflow-tooltip="true"
                             :formatter="setAffiliations"></el-table-column>
            <el-table-column prop="date" label="发表时间" width="90" align="center" :show-overflow-tooltip="true"
                             :formatter="setDate"></el-table-column>
            <el-table-column prop="ref" label="被引" width="90" align="center" :show-overflow-tooltip="true"
                             :formatter="setRef"></el-table-column>
