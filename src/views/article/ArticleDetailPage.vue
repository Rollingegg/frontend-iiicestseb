    ...
    <div>
        <el-row v-loading="loading" element-loading-background="rgba(255,255,255,0.95)">
            <el-col :md="16" class="col-container">
                        ...
                        <div class="info-container">
                            ...
                            <el-row class="author-row">
                                ...
                                <el-col :md="20" class="author-content">
                                    <el-link v-for="(item, index) in authors"
                                             :key="index"
                            ...
                            <el-row class="author-row">
                                ...
                                <el-col :md="20" class="author-content">
                                    <el-link v-for="(item, index) in affiliations"
                                             :key="index"
                ...
                <paper-recommend :papers="recommendedPapers"/>
            </el-col>
            <el-col :md="8" class="col-container">
                ...
                <div class="list-container">
                    <el-card v-for="(item, index) in references.slice((currentPage-1)*pageSize,currentPage*pageSize)"
                             :key="index"
                ...
                <!-- <AuthorRecommend :authors="recommendedAuthors"/> -->
                <!-- <AffiliationRecommend :affiliations="recommendedAffiliations"/> -->
            </el-col>
        </el-row>
